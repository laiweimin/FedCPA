...
class Client(object):
    ...
    def load_train_data(self, batch_size=None):
        ...
        return DataLoader(train_data, batch_size, drop_last=True, shuffle=True)#  num_workers=8
    ...
    def set_FedForgotten(self):
        self.Forgotten_optimizer = ada_hessain.AdaHessian(self.model.parameters())
