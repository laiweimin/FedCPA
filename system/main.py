...
if __name__ == "__main__":
    ...
    parser.add_argument('-algo', "--algorithm", type=str, default="Camouflaged_FedAvg")
    ...
    parser.add_argument('-cstart', "--camouflage_start_epoch", type=int, default=5)
    ...
    parser.add_argument('-def', "--defense", type=str, default="NoDefense",
                        choices=["NoDefense", "Krum", "TrimmedMean", "Bulyan", "LIE", "Median"])
